        ...
        <div class="bg-white border-[2.5px] border-slate-900 p-6 sm:p-8 rounded-[24px] shadow-[6px_6px_0px_0px_#1a1a1a]">
            ...
            <div class="grid sm:grid-cols-2 gap-6">
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-base mb-1">Pengolahan Materi Rapi</h3>
                        <p class="font-sans text-xs text-slate-600">Penyusunan materi Anda menjadi makalah yang terstruktur dan akademik</p>
                    </div>
                </div>
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-base mb-1">Pengerjaan Ekstra Cepat</h3>
                        <p class="font-sans text-xs text-slate-600">Proses kilat 1-6 jam karena materi sudah tersedia dari Anda</p>
                    </div>
                </div>
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-base mb-1">Format Standar Akademik</h3>
                        <p class="font-sans text-xs text-slate-600">Lengkap dengan cover, kata pengantar, daftar isi, pembahasan & penutup</p>
                    </div>
                </div>
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        ...
                        <p class="font-sans text-xs text-slate-600">Mendapatkan file akhir siap pakai (.docx dan .pdf)</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-[#ffdd44] border-[2.5px] border-slate-900 p-6 sm:p-8 rounded-[24px] shadow-[6px_6px_0px_0px_#1a1a1a]">
            ...
            <div class="grid sm:grid-cols-2 gap-6">
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-sm mb-1">Kirim Materi & Pesan</h3>
                        <p class="font-sans text-xs text-slate-700">Kirimkan file materi, topik, dan ketentuan makalah Anda.</p>
                    </div>
                </div>
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
                    ...
                    <div>
                        ...
                        <p class="font-sans text-xs text-slate-700">Kami cek materi dan lakukan konfirmasi pembayaran.</p>
                    </div>
                </div>
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
                    ...
                    <div>
                        ...
                        <p class="font-sans text-xs text-slate-700">Tim kami menyusun materi Anda dengan rapi dan sistematis.</p>
                    </div>
                </div>
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-sm mb-1">Pengiriman & Revisi</h3>
                        <p class="font-sans text-xs text-slate-700">File dikirim tepat waktu dengan garansi revisi gratis.</p>
                    </div>
                </div>
            </div>
        </div>
