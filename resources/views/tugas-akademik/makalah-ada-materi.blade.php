...
<section class="py-10 md:py-14 bg-[#faf8ef] text-slate-900">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 text-center">
        ...
        <h1 class="text-3xl sm:text-5xl font-extrabold text-slate-900 tracking-tight mb-4 leading-tight" data-i18n="svc_makalah_ada_materi_name">
            {{ $service->name }}
        </h1>
        
        <p class="font-sans text-sm sm:text-base text-slate-700 max-w-xl mx-auto mb-6" data-i18n="svc_makalah_ada_materi_desc">
            Penyusunan & pengetikan makalah dari draft materi/bahan yang sudah Anda siapkan.
        </p>
        ...
        <div class="inline-flex flex-wrap items-center justify-center gap-4 bg-white text-slate-900 border-2 border-slate-900 px-5 py-2.5 rounded-2xl shadow-[4px_4px_0px_0px_#1a1a1a]">
            <div class="flex items-center gap-2.5 font-bold text-xs sm:text-sm">
                ...
                <span data-i18n="badge_time_1_6_h">1 - 6 Jam</span>
            </div>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 space-y-12">
        <div class="bg-white border-[2.5px] border-slate-900 p-6 sm:p-8 rounded-[24px] shadow-[6px_6px_0px_0px_#1a1a1a]">
            ...
            <div class="font-sans text-sm sm:text-base text-slate-700 space-y-4 leading-relaxed">
                <p data-i18n="makalah_ada_materi_p1">
                    Jasa Pembuatan Makalah (Ada Materi) adalah layanan yang cocok jika Anda sudah memiliki materi, buku, atau referensi untuk makalah. Kami akan mengolah materi yang Anda berikan menjadi makalah yang sistematis, terstruktur, dan siap dikumpulkan.
                </p>
                <p data-i18n="makalah_ada_materi_p2">
        ...
        <div class="bg-white border-[2.5px] border-slate-900 p-6 sm:p-8 rounded-[24px] shadow-[6px_6px_0px_0px_#1a1a1a]">
            ...
            <div class="grid sm:grid-cols-2 gap-6">
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-lg mb-1" data-i18n="makalah_feat1_title">Pengolahan Materi Rapi</h3>
                        <p class="font-sans text-sm text-slate-600" data-i18n="makalah_feat1_desc">Penyusunan materi Anda menjadi makalah yang terstruktur dan akademik</p>
                    </div>
                </div>
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-lg mb-1" data-i18n="makalah_feat2_title">Pengerjaan Ekstra Cepat</h3>
                        <p class="font-sans text-sm text-slate-600" data-i18n="makalah_feat2_desc">Proses kilat 1-6 jam karena materi sudah tersedia dari Anda</p>
                    </div>
                </div>
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-lg mb-1" data-i18n="makalah_feat3_title">Format Standar Akademik</h3>
                        <p class="font-sans text-sm text-slate-600" data-i18n="makalah_feat3_desc">Lengkap dengan cover, kata pengantar, daftar isi, pembahasan & penutup</p>
                    </div>
                </div>
                <div class="flex gap-4 items-start">
        ...
        <div class="flex items-center justify-between gap-3">
            ...
            <div class="flex items-center gap-4">
                <div class="hidden sm:block text-right">
                    <p class="font-extrabold text-slate-900 text-sm leading-tight" data-i18n="svc_makalah_ada_materi_name">{{ $service->name }}</p>
