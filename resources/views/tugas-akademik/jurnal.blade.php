        ...
        <div class="bg-white border-[2.5px] border-slate-900 p-6 sm:p-8 rounded-[24px] shadow-[6px_6px_0px_0px_#1a1a1a]">
            ...
            <div class="grid sm:grid-cols-2 gap-6">
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-base mb-1">Metodologi Proper</h3>
                        <p class="font-sans text-xs text-slate-600">Penyusunan metode penelitian yang jelas dan ilmiah</p>
                    </div>
                </div>
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-base mb-1">Format IMRAD</h3>
                        <p class="font-sans text-xs text-slate-600">Abstract, Introduction, Method, Results, Discussion & References</p>
                    </div>
                </div>
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-base mb-1">Referensi Terbaru</h3>
                        <p class="font-sans text-xs text-slate-600">Dukungan sumber jurnal bereputasi & kutipan relevan</p>
                    </div>
                </div>
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-base mb-1">Bebas Plagiasi</h3>
                        <p class="font-sans text-xs text-slate-600">Garansi keaslian konten dan lolos cek plagiarisme</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-[#ffdd44] border-[2.5px] border-slate-900 p-6 sm:p-8 rounded-[24px] shadow-[6px_6px_0px_0px_#1a1a1a]">
            ...
            <div class="grid sm:grid-cols-2 gap-6">
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-sm mb-1">Diskusi Topik & Bidang</h3>
                        <p class="font-sans text-xs text-slate-700">Sampaikan bidang studi, topik jurnal, dan template yang diminta.</p>
                    </div>
                </div>
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-sm mb-1">Konfirmasi & DP/Bayar</h3>
                        <p class="font-sans text-xs text-slate-700">Kami estimasikan pengerjaan dan konfirmasi pembayaran.</p>
                    </div>
                </div>
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-sm mb-1">Penulisan Jurnal</h3>
                        <p class="font-sans text-xs text-slate-700">Penyusunan abstrak, pembahasan, & referensi oleh tim ahli.</p>
                    </div>
                </div>
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-sm mb-1">Penyerahan File & Revisi</h3>
                        <p class="font-sans text-xs text-slate-700">Penyerahan draf jurnal dengan garansi revisi sampai sesuai.</p>
                    </div>
                </div>
            </div>
        </div>
