...
<section class="py-10 md:py-14 bg-[#faf8ef] text-slate-900">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 text-center">
        ...
        <p class="font-sans text-sm sm:text-base text-slate-700 max-w-xl mx-auto mb-6">
            Bantuan penyelesaian berbagai tugas sekolah dan kuliah secara cepat, akurat, & tepat waktu.
        </p>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 space-y-12">
        <div class="bg-white border-[2.5px] border-slate-900 p-6 sm:p-8 rounded-[24px] shadow-[6px_6px_0px_0px_#1a1a1a]">
            ...
            <div class="font-sans text-sm sm:text-base text-slate-700 space-y-4 leading-relaxed">
                ...
                <p>
                    Pengerjaan kilat super cepat dalam 3 jam, sangat pas untuk Anda yang sedang dikejar deadline ketat!
                </p>
            </div>
        </div>
        ...
        <div class="bg-white border-[2.5px] border-slate-900 p-6 sm:p-8 rounded-[24px] shadow-[6px_6px_0px_0px_#1a1a1a]">
            ...
            <div class="grid sm:grid-cols-2 gap-6">
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-base mb-1">Super Cepat</h3>
                        <p class="font-sans text-xs text-slate-600">Selesai dalam 3 jam, perfect untuk deadline mendadak</p>
                    </div>
                </div>
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-base mb-1">Jawaban Akurat</h3>
                        <p class="font-sans text-xs text-slate-600">Dikerjakan dengan teliti sesuai soal atau instruksi tugas</p>
                    </div>
                </div>
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-base mb-1">Format Rapi</h3>
                        <p class="font-sans text-xs text-slate-600">Siap dikumpulkan dalam format Word, PDF, atau gambar sesuai permintaan</p>
                    </div>
                </div>
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        ...
                        <p class="font-sans text-xs text-slate-600">Garansi penyesuaian jika ada soal yang perlu dikoreksi</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-[#ffdd44] border-[2.5px] border-slate-900 p-6 sm:p-8 rounded-[24px] shadow-[6px_6px_0px_0px_#1a1a1a]">
            ...
            <div class="grid sm:grid-cols-2 gap-6">
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-sm mb-1">Kirim Soal / Tugas</h3>
                        <p class="font-sans text-xs text-slate-700">Kirimkan soal atau instruksi tugas melalui form order.</p>
                    </div>
                </div>
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-sm mb-1">Pembayaran Instan</h3>
                        <p class="font-sans text-xs text-slate-700">Lakukan pembayaran untuk memulai proses pengerjaan kilat.</p>
                    </div>
                </div>
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-sm mb-1">Pengerjaan Kilat</h3>
                        <p class="font-sans text-xs text-slate-700">Tim kami mengerjakan tugas Anda dengan akurat dalam 3 jam.</p>
                    </div>
                </div>
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
                    ...
                    <div>
                        ...
                        <p class="font-sans text-xs text-slate-700">File jawaban tugas dikirimkan dan siap Anda kumpulkan.</p>
                    </div>
                </div>
            </div>
        </div>
