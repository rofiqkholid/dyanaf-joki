<footer class="bg-[#faf8ef] border-t-2 border-slate-900 py-12 text-slate-900">
    <div class="max-w-5xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-8 mb-10">
        <div class="space-y-3">
            ...
            <p data-i18n="footer_about" class="font-sans text-sm text-slate-700 leading-relaxed">
        ...
        <div>
            <h4 data-i18n="footer_hubungi" class="font-extrabold text-base mb-4">Hubungi Kami</h4>
            ...
            <p data-i18n="footer_hours" class="font-sans text-sm text-slate-700 font-medium">Jam Kerja: Senin - Sabtu, 09:00 - 18:00</p>
        </div>
    </div>

    <div data-i18n="footer_rights" class="max-w-5xl mx-auto px-6 border-t border-slate-300 pt-6 text-center font-sans text-sm font-medium text-slate-600">
