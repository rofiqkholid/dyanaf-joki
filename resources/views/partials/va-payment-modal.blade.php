...
<div id="vaPaymentModal" class="fixed inset-0 z-[100] hidden" aria-labelledby="va-payment-title" role="dialog" aria-modal="true">
    ...
    <div class="fixed inset-0 z-10 flex items-center justify-center p-0 sm:p-4">
        <!-- Modal Panel -->
        <div id="vaPanel" class="relative w-full h-full sm:h-auto sm:max-h-[90vh] sm:max-w-2xl bg-[#faf8ef] rounded-none sm:rounded-[24px] border-0 sm:border-[3px] border-slate-900 shadow-none sm:shadow-[8px_8px_0px_0px_#1a1a1a] transition-all duration-300 ease-out scale-95 opacity-0 flex flex-col overflow-hidden">
