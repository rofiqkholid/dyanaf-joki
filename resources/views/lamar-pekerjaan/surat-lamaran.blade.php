    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 space-y-12">
        <div class="bg-white border-[2.5px] border-slate-900 p-6 sm:p-8 rounded-[24px] shadow-[6px_6px_0px_0px_#1a1a1a]">
            ...
            <div class="font-sans text-sm sm:text-base text-slate-700 space-y-4 leading-relaxed">
                <p>
                    <strong>Surat Lamaran Kerja (Cover Letter)</strong> yang ditulis dengan tata bahasa formal dan menarik akan menunjukkan keseriusan Anda dalam melamar pekerjaan. Kami buatkan surat lamaran unik yang menonjolkan motivasi dan nilai tambah Anda.
                </p>
            </div>
        </div>
        ...
        <div class="bg-white border-[2.5px] border-slate-900 p-6 sm:p-8 rounded-[24px] shadow-[6px_6px_0px_0px_#1a1a1a]">
            ...
            <div class="grid sm:grid-cols-2 gap-6">
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-base mb-1">Tata Bahasa Formal & Persuasif</h3>
                        <p class="font-sans text-xs text-slate-600">Diketik rapi sesuai EYD & kausa profesionalisme HRD</p>
                    </div>
                </div>
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        ...
                        <p class="font-sans text-xs text-slate-600">Pengerjaan cepat siap kirim dalam 3 jam</p>
                    </div>
                </div>
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-base mb-1">Custom Per Posisi</h3>
                        <p class="font-sans text-xs text-slate-600">Konten disesuaikan dengan posisi & perusahaan yang dituju</p>
                    </div>
                </div>
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-base mb-1">File Editable & PDF</h3>
                        <p class="font-sans text-xs text-slate-600">Dapatkan file .docx yang mudah diedit dan PDF siap pakai</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-[#ffdd44] border-[2.5px] border-slate-900 p-6 sm:p-8 rounded-[24px] shadow-[6px_6px_0px_0px_#1a1a1a]">
            ...
            <div class="grid sm:grid-cols-2 gap-6">
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-sm mb-1">Isi Data & Posisi Target</h3>
                        <p class="font-sans text-xs text-slate-700">Kirimkan info posisi & nama perusahaan yang dilamar.</p>
                    </div>
                </div>
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
                    ...
                    <div>
                        ...
                        <p class="font-sans text-xs text-slate-700">Konfirmasi pembayaran untuk memproses penulisan.</p>
                    </div>
                </div>
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-sm mb-1">Penyusunan Surat</h3>
                        <p class="font-sans text-xs text-slate-700">Penulis profesional kami menyusun surat lamaran persuasif.</p>
                    </div>
                </div>
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-sm mb-1">Pengiriman File</h3>
                        <p class="font-sans text-xs text-slate-700">File surat lamaran dikirimkan lengkap dengan garansi revisi.</p>
                    </div>
                </div>
            </div>
        </div>
