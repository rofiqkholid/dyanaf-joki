        ...
        <div class="bg-white border-[2.5px] border-slate-900 p-6 sm:p-8 rounded-[24px] shadow-[6px_6px_0px_0px_#1a1a1a]">
            ...
            <div class="grid sm:grid-cols-2 gap-6">
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-lg mb-1">Desain Visual Modern</h3>
                        <p class="font-sans text-sm text-slate-600">Pilihan layout kreatif menarik dengan kombinasi warna elegan</p>
                    </div>
                </div>
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        ...
                        <p class="font-sans text-sm text-slate-600">Proses pengerjaan kilat siap kirim dalam 3 jam</p>
                    </div>
                </div>
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-lg mb-1">Format PDF HD & Image</h3>
                        <p class="font-sans text-sm text-slate-600">Mendapatkan file PDF berkualitas tinggi dan file gambar</p>
                    </div>
                </div>
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-lg mb-1">Garansi Revisi</h3>
                        <p class="font-sans text-sm text-slate-600">Bebas revisi jika ada penyesuaian data/layout</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-[#ffdd44] border-[2.5px] border-slate-900 p-6 sm:p-8 rounded-[24px] shadow-[6px_6px_0px_0px_#1a1a1a]">
            ...
            <div class="grid sm:grid-cols-2 gap-6">
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-lg mb-1">Isi Form & Pilih Template</h3>
                        <p class="font-sans text-sm text-slate-700">Kirimkan data diri & foto formal/setengah badan Anda.</p>
                    </div>
                </div>
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
                    ...
                    <div>
                        ...
                        <p class="font-sans text-sm text-slate-700">Konfirmasi pembayaran untuk memulainya.</p>
                    </div>
                </div>
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-lg mb-1">Proses Desain</h3>
                        <p class="font-sans text-sm text-slate-700">Desainer profesional kami merancang CV estetis Anda.</p>
                    </div>
                </div>
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
                    ...
                    <div>
                        ...
                        <p class="font-sans text-sm text-slate-700">File CV kreatif dikirim dengan garansi kepuasan.</p>
                    </div>
                </div>
            </div>
        </div>
