...
<section class="py-10 md:py-14 bg-[#faf8ef] text-slate-900">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 text-center">
        ...
        <h1 class="text-3xl sm:text-5xl font-extrabold text-slate-900 tracking-tight mb-4 leading-tight" data-i18n="svc_cv_kreatif_name">
            {{ $service->name }}
        </h1>
        
        <p class="font-sans text-sm sm:text-base text-slate-700 max-w-xl mx-auto mb-6" data-i18n="svc_cv_kreatif_desc">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 space-y-12">
        <div class="bg-white border-[2.5px] border-slate-900 p-6 sm:p-8 rounded-[24px] shadow-[6px_6px_0px_0px_#1a1a1a]">
            ...
            <div class="font-sans text-sm sm:text-base text-slate-700 space-y-4 leading-relaxed">
                <p data-i18n="cv_kreatif_p1">
                    CV Kreatif sangat cocok bagi Anda yang melamar posisi di bidang kreatif (desain, marketing, media, komunikasi) atau perusahaan yang mengutamakan visual resume menarik. CV didesain dengan perpaduan warna dan tata letak yang menarik perhatian HRD.
                </p>
            </div>
        </div>
        ...
        <div class="bg-white border-[2.5px] border-slate-900 p-6 sm:p-8 rounded-[24px] shadow-[6px_6px_0px_0px_#1a1a1a]">
            ...
            <div class="grid sm:grid-cols-2 gap-6">
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-lg mb-1" data-i18n="cv_kr_feat1_title">Desain Visual Modern</h3>
                        <p class="font-sans text-sm text-slate-600" data-i18n="cv_kr_feat1_desc">Pilihan layout kreatif menarik dengan kombinasi warna elegan</p>
                    </div>
                </div>
                <div class="flex gap-4 items-start">
                ...
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-lg mb-1" data-i18n="cv_kr_feat3_title">Format PDF HD & Image</h3>
                        <p class="font-sans text-sm text-slate-600" data-i18n="cv_kr_feat3_desc">Mendapatkan file PDF berkualitas tinggi dan file gambar</p>
                    </div>
                </div>
                <div class="flex gap-4 items-start">
        ...
        <div class="bg-[#ffdd44] border-[2.5px] border-slate-900 p-6 sm:p-8 rounded-[24px] shadow-[6px_6px_0px_0px_#1a1a1a]">
            ...
            <div class="grid sm:grid-cols-2 gap-6">
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-lg mb-1" data-i18n="step1_title">Isi Form Data CV</h3>
                        <p class="font-sans text-sm text-slate-700" data-i18n="step1_desc">Kirimkan data pengalaman, pendidikan, dan foto Anda.</p>
                    </div>
                </div>
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
                ...
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
                    ...
                    <div>
                        ...
                        <p class="font-sans text-sm text-slate-700" data-i18n="step3_desc">Tim kami mendesain CV Anda dengan visual estetik.</p>
                    </div>
                </div>
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
        ...
        <div class="flex items-center justify-between gap-3">
            ...
            <div class="flex items-center gap-4">
                <div class="hidden sm:block text-right">
                    <p class="font-extrabold text-slate-900 text-sm leading-tight" data-i18n="svc_cv_kreatif_name">{{ $service->name }}</p>
