        ...
        <div class="bg-white border-[2.5px] border-slate-900 p-6 sm:p-8 rounded-[24px] shadow-[6px_6px_0px_0px_#1a1a1a]">
            ...
            <div class="grid sm:grid-cols-2 gap-6">
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-base mb-1">ATS Optimized</h3>
                        <p class="font-sans text-xs text-slate-600">Format yang mudah dibaca oleh Applicant Tracking System</p>
                    </div>
                </div>
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        ...
                        <p class="font-sans text-xs text-slate-600">Proses pengerjaan super cepat 3 jam selesai</p>
                    </div>
                </div>
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-base mb-1">Keyword Optimization</h3>
                        <p class="font-sans text-xs text-slate-600">Penyesuaian kata kunci sesuai posisi pekerjaan yang dilamar</p>
                    </div>
                </div>
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-base mb-1">Format Word & PDF</h3>
                        <p class="font-sans text-xs text-slate-600">Mendapatkan master file edit (.docx) dan PDF siap kirim</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-[#ffdd44] border-[2.5px] border-slate-900 p-6 sm:p-8 rounded-[24px] shadow-[6px_6px_0px_0px_#1a1a1a]">
            ...
            <div class="grid sm:grid-cols-2 gap-6">
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-sm mb-1">Isi Form & Data CV</h3>
                        <p class="font-sans text-xs text-slate-700">Kirimkan riwayat hidup/pengalaman Anda melalui form order.</p>
                    </div>
                </div>
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
                    ...
                    <div>
                        ...
                        <p class="font-sans text-xs text-slate-700">Lakukan pembayaran untuk memproses penulisan CV ATS Anda.</p>
                    </div>
                </div>
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-sm mb-1">Optimasi ATS</h3>
                        <p class="font-sans text-xs text-slate-700">Tim kami menyusun tata letak & kata kunci sesuai standar ATS.</p>
                    </div>
                </div>
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
                    ...
                    <div>
                        ...
                        <p class="font-sans text-xs text-slate-700">CV ATS selesai dikirimkan lengkap dengan garansi revisi.</p>
                    </div>
                </div>
            </div>
        </div>
