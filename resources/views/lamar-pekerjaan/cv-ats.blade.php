...
<section class="py-10 md:py-14 bg-[#faf8ef] text-slate-900">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 text-center">
        ...
        <h1 class="text-3xl sm:text-5xl font-extrabold text-slate-900 tracking-tight mb-4 leading-tight" data-i18n="svc_cv_ats_name">
            {{ $service->name }}
        </h1>
        
        <p class="font-sans text-sm sm:text-base text-slate-700 max-w-xl mx-auto mb-6" data-i18n="svc_cv_ats_desc">
        ...
        <div class="bg-white border-[2.5px] border-slate-900 p-6 sm:p-8 rounded-[24px] shadow-[6px_6px_0px_0px_#1a1a1a]">
            ...
            <div class="grid sm:grid-cols-2 gap-6">
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-lg mb-1" data-i18n="cv_ats_feat1_title">Format Standar ATS</h3>
                        <p class="font-sans text-sm text-slate-600" data-i18n="cv_ats_feat1_desc">Struktur tata letak standar sistem rekrutmen perusahaan</p>
                    </div>
                </div>
                <div class="flex gap-4 items-start">
            ...
            <div class="grid sm:grid-cols-2 gap-6">
                ...
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
                    ...
                    <div>
                        ...
                        <p class="font-sans text-sm text-slate-700" data-i18n="step3_desc">Tim kami menyusun CV ATS Anda dengan rapi.</p>
                    </div>
                </div>
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
        ...
        <div class="flex items-center justify-between gap-3">
            ...
            <div class="flex items-center gap-4">
                <div class="hidden sm:block text-right">
                    <p class="font-extrabold text-slate-900 text-sm leading-tight" data-i18n="svc_cv_ats_name">{{ $service->name }}</p>
