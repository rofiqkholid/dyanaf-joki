...
<section class="py-10 md:py-14 bg-[#faf8ef] text-slate-900">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 text-center">
        <div class="inline-flex items-center gap-2 px-3.5 py-1.5 bg-[#8be4d6] text-slate-900 border-2 border-slate-900 rounded-lg text-xs font-black mb-5 shadow-[3px_3px_0px_0px_#1a1a1a]">
            <i class="fa-solid fa-file-pdf text-slate-900"></i>
        ...
        <p class="font-sans text-sm sm:text-base text-slate-700 max-w-xl mx-auto mb-6">
            Penggabungan, perapihan urutan, kompresi ukuran, & konversi berkas PDF berkas lamaran Anda.
        </p>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 space-y-12">
        <div class="bg-white border-[2.5px] border-slate-900 p-6 sm:p-8 rounded-[24px] shadow-[6px_6px_0px_0px_#1a1a1a]">
            ...
            <div class="font-sans text-sm sm:text-base text-slate-700 space-y-4 leading-relaxed">
                <p>
                    <strong>Layanan Gabung PDF</strong> membantu Anda menggabungkan berbagai dokumen lamaran (CV, ijazah, transkrip, sertifikat, KTP) menjadi satu file PDF yang tersusun rapi dengan urutan yang benar dan ukuran file yang dioptimalkan sesuai batas maksimal upload email/portal kerja.
                </p>
            </div>
        </div>
        ...
        <div class="bg-white border-[2.5px] border-slate-900 p-6 sm:p-8 rounded-[24px] shadow-[6px_6px_0px_0px_#1a1a1a]">
            ...
            <div class="grid sm:grid-cols-2 gap-6">
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-base mb-1">Penggabungan File Rapi</h3>
                        <p class="font-sans text-xs text-slate-600">Penyusunan urutan berkas secara profesional</p>
                    </div>
                </div>
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-base mb-1">Kompresi Tanpa Pecah</h3>
                        <p class="font-sans text-xs text-slate-600">Pengecilan ukuran file agar muat di sistem portal HRD</p>
                    </div>
                </div>
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-base mb-1">Proses Cepat 1 Jam</h3>
                        <p class="font-sans text-xs text-slate-600">Selesai dalam 1 jam langsung siap digunakan</p>
                    </div>
                </div>
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-base mb-1">Privasi Terjaga</h3>
                        <p class="font-sans text-xs text-slate-600">Keamanan data dan kerahasiaan dokumen 100% aman</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-[#ffdd44] border-[2.5px] border-slate-900 p-6 sm:p-8 rounded-[24px] shadow-[6px_6px_0px_0px_#1a1a1a]">
            ...
            <div class="grid sm:grid-cols-2 gap-6">
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-sm mb-1">Kirim Berkas Dokumen</h3>
                        <p class="font-sans text-xs text-slate-700">Kirimkan file-file PDF/gambar yang ingin digabungkan.</p>
                    </div>
                </div>
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
                    ...
                    <div>
                        ...
                        <p class="font-sans text-xs text-slate-700">Lakukan pembayaran murah Rp 10.000 saja.</p>
                    </div>
                </div>
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-sm mb-1">Proses Penggabungan</h3>
                        <p class="font-sans text-xs text-slate-700">Tim kami merapikan urutan dan kompresi file.</p>
                    </div>
                </div>
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-sm mb-1">File PDF Siap Kirim</h3>
                        <p class="font-sans text-xs text-slate-700">File gabungan dikirimkan langsung ke WhatsApp/Email Anda.</p>
                    </div>
                </div>
            </div>
        </div>
