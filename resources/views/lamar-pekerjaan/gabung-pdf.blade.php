...
<section class="py-10 md:py-14 bg-[#faf8ef] text-slate-900">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 text-center">
        ...
        <h1 class="text-3xl sm:text-5xl font-extrabold text-slate-900 tracking-tight mb-4 leading-tight" data-i18n="svc_gabung_pdf_name">
            {{ $service->name }}
        </h1>
        
        <p class="font-sans text-sm sm:text-base text-slate-700 max-w-xl mx-auto mb-6" data-i18n="svc_gabung_pdf_desc">
        ...
        <div class="inline-flex flex-wrap items-center justify-center gap-4 bg-white text-slate-900 border-2 border-slate-900 px-5 py-2.5 rounded-2xl shadow-[4px_4px_0px_0px_#1a1a1a]">
            <div class="flex items-center gap-2.5 font-bold text-xs sm:text-sm">
                ...
                <span data-i18n="time_1_h">1 Jam</span>
            </div>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 space-y-12">
        <div class="bg-white border-[2.5px] border-slate-900 p-6 sm:p-8 rounded-[24px] shadow-[6px_6px_0px_0px_#1a1a1a]">
            ...
            <div class="font-sans text-sm sm:text-base text-slate-700 space-y-4 leading-relaxed">
                <p data-i18n="gabung_pdf_p1">
                    Layanan Gabung PDF membantu Anda menggabungkan berbagai dokumen lamaran (CV, ijazah, transkrip, sertifikat, KTP) menjadi satu file PDF yang tersusun rapi dengan urutan yang benar dan ukuran file yang dioptimalkan sesuai batas maksimal upload email/portal kerja.
                </p>
            </div>
        </div>
        ...
        <div class="bg-white border-[2.5px] border-slate-900 p-6 sm:p-8 rounded-[24px] shadow-[6px_6px_0px_0px_#1a1a1a]">
            ...
            <div class="grid sm:grid-cols-2 gap-6">
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-lg mb-1" data-i18n="gabung_pdf_feat1_title">Penggabungan Rapi</h3>
                        <p class="font-sans text-sm text-slate-600" data-i18n="gabung_pdf_feat1_desc">Pengurutan halaman sesuai standar berkas lamaran kerja</p>
                    </div>
                </div>
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-lg mb-1" data-i18n="gabung_pdf_feat2_title">Kompresi Ukuran File</h3>
                        <p class="font-sans text-sm text-slate-600" data-i18n="gabung_pdf_feat2_desc">Optimasi ukuran file agar di bawah 2MB / 1MB tanpa merusak kualitas</p>
                    </div>
                </div>
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-lg mb-1" data-i18n="gabung_pdf_feat3_title">Proses 1 Jam</h3>
                        <p class="font-sans text-sm text-slate-600" data-i18n="gabung_pdf_feat3_desc">Pengerjaan instan dan cepat</p>
                    </div>
                </div>
                <div class="flex gap-4 items-start">
            ...
            <div class="grid sm:grid-cols-2 gap-6">
                ...
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
                    ...
                    <div>
                        ...
                        <p class="font-sans text-sm text-slate-700" data-i18n="step3_desc">Tim kami menyusun dokumen Anda dengan rapi.</p>
                    </div>
                </div>
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
        ...
        <div class="flex items-center justify-between gap-3">
            ...
            <div class="flex items-center gap-4">
                <div class="hidden sm:block text-right">
                    <p class="font-extrabold text-slate-900 text-sm leading-tight" data-i18n="svc_gabung_pdf_name">{{ $service->name }}</p>
