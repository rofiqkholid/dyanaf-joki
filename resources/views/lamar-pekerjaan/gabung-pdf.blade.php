        ...
        <div class="bg-white border-[2.5px] border-slate-900 p-6 sm:p-8 rounded-[24px] shadow-[6px_6px_0px_0px_#1a1a1a]">
            ...
            <div class="grid sm:grid-cols-2 gap-6">
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-lg mb-1">Penggabungan File Rapi</h3>
                        <p class="font-sans text-sm text-slate-600">Penyusunan urutan berkas secara profesional</p>
                    </div>
                </div>
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-lg mb-1">Kompresi Tanpa Pecah</h3>
                        <p class="font-sans text-sm text-slate-600">Pengecilan ukuran file agar muat di sistem portal HRD</p>
                    </div>
                </div>
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-lg mb-1">Proses Cepat 1 Jam</h3>
                        <p class="font-sans text-sm text-slate-600">Selesai dalam 1 jam langsung siap digunakan</p>
                    </div>
                </div>
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-lg mb-1">Privasi Terjaga</h3>
                        <p class="font-sans text-sm text-slate-600">Keamanan data dan kerahasiaan dokumen 100% aman</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-[#ffdd44] border-[2.5px] border-slate-900 p-6 sm:p-8 rounded-[24px] shadow-[6px_6px_0px_0px_#1a1a1a]">
            ...
            <div class="grid sm:grid-cols-2 gap-6">
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-lg mb-1">Kirim Berkas Dokumen</h3>
                        <p class="font-sans text-sm text-slate-700">Kirimkan file-file PDF/gambar yang ingin digabungkan.</p>
                    </div>
                </div>
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-lg mb-1">Pembayaran</h3>
                        <p class="font-sans text-sm text-slate-700">Lakukan pembayaran murah Rp 10.000 saja.</p>
                    </div>
                </div>
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-lg mb-1">Proses Penggabungan</h3>
                        <p class="font-sans text-sm text-slate-700">Tim kami merapikan urutan dan kompresi file.</p>
                    </div>
                </div>
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-lg mb-1">File PDF Siap Kirim</h3>
                        <p class="font-sans text-sm text-slate-700">File gabungan dikirimkan langsung ke WhatsApp/Email Anda.</p>
                    </div>
                </div>
            </div>
        </div>
