        ...
        <div class="bg-white border-[2.5px] border-slate-900 p-6 sm:p-8 rounded-[24px] shadow-[6px_6px_0px_0px_#1a1a1a]">
            ...
            <div class="grid sm:grid-cols-2 gap-6">
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-lg mb-1">File Word Rapi & Bebas Typo</h3>
                        <p class="font-sans text-sm text-slate-600">Diketik teliti dengan tata letak dan tata bahasa yang sesuai</p>
                    </div>
                </div>
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-lg mb-1">Format Sesuai Request</h3>
                        <p class="font-sans text-sm text-slate-600">Atur margin, ukuran font, spasi, header/footer sesuai kebutuhan</p>
                    </div>
                </div>
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-lg mb-1">Pengerjaan Kilat</h3>
                        <p class="font-sans text-sm text-slate-600">Tersedia layanan pengetikan super cepat 6 jam langsung selesai</p>
                    </div>
                </div>
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-lg mb-1">Format .docx & .pdf</h3>
                        <p class="font-sans text-sm text-slate-600">Dapatkan file Microsoft Word yang editable dan versi cetak PDF</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-[#ffdd44] border-[2.5px] border-slate-900 p-6 sm:p-8 rounded-[24px] shadow-[6px_6px_0px_0px_#1a1a1a]">
            ...
            <div class="grid sm:grid-cols-2 gap-6">
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-lg mb-1">Kirim Berkas Sumber</h3>
                        <p class="font-sans text-sm text-slate-700">Kirimkan foto/scan/coretan dokumen yang perlu diketik.</p>
                    </div>
                </div>
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-lg mb-1">Set Format Dokumen</h3>
                        <p class="font-sans text-sm text-slate-700">Tentukan aturan format (jenis font, ukuran, margin, dll).</p>
                    </div>
                </div>
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-lg mb-1">Proses Pengetikan</h3>
                        <p class="font-sans text-sm text-slate-700">Tim mengetik dokumen secara cepat dan presisi.</p>
                    </div>
                </div>
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-lg mb-1">Proofread & Penyerahan</h3>
                        <p class="font-sans text-sm text-slate-700">Pengecekan ejaan akhir dan pengiriman file .docx & .pdf.</p>
                    </div>
                </div>
            </div>
        </div>
