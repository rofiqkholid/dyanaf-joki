...
<section class="py-10 md:py-14 bg-[#faf8ef] text-slate-900">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 text-center">
        ...
        <h1 class="text-3xl sm:text-5xl font-extrabold text-slate-900 tracking-tight mb-4 leading-tight" data-i18n="svc_web_statis_name">
            {{ $service->name }}
        </h1>
        
        <p class="font-sans text-sm sm:text-base text-slate-700 max-w-xl mx-auto mb-6" data-i18n="svc_web_statis_desc">
        ...
        <div class="inline-flex flex-wrap items-center justify-center gap-4 bg-white text-slate-900 border-2 border-slate-900 px-5 py-2.5 rounded-2xl shadow-[4px_4px_0px_0px_#1a1a1a]">
            <div class="flex items-center gap-2.5 font-bold text-xs sm:text-sm">
                ...
                <span data-i18n="time_2_4_d">2 - 4 Hari</span>
            </div>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 space-y-12">
        <div class="bg-white border-[2.5px] border-slate-900 p-6 sm:p-8 rounded-[24px] shadow-[6px_6px_0px_0px_#1a1a1a]">
            ...
            <div class="font-sans text-sm sm:text-base text-slate-700 space-y-4 leading-relaxed">
                <p data-i18n="web_statis_p1">
                    Jasa Pembuatan Website Statis sangat cocok untuk profile perusahaan (company profile), landing page promosi produk, website portofolio pribadi, atau usaha UMKM yang membutuhkan kehadiran digital profesional dengan kecepatan akses maksimal.
                </p>
                <p data-i18n="web_statis_p2">
        ...
        <div class="bg-white border-[2.5px] border-slate-900 p-6 sm:p-8 rounded-[24px] shadow-[6px_6px_0px_0px_#1a1a1a]">
            ...
            <div class="grid sm:grid-cols-2 gap-6">
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-lg mb-1" data-i18n="web_st_feat1_title">Desain Modern & Responsif</h3>
                        <p class="font-sans text-sm text-slate-600" data-i18n="web_st_feat1_desc">Tampilan profesional dan rapi di layar HP maupun komputer</p>
                    </div>
                </div>
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-lg mb-1" data-i18n="web_st_feat2_title">Free Domain & Hosting</h3>
                        <p class="font-sans text-sm text-slate-600" data-i18n="web_st_feat2_desc">Sudah termasuk domain .com / .my.id & SSL keamanan gratis</p>
                    </div>
                </div>
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-lg mb-1" data-i18n="web_st_feat3_title">Tombol Direct WhatsApp</h3>
                        <p class="font-sans text-sm text-slate-600" data-i18n="web_st_feat3_desc">Memudahkan pengunjung langsung menghubungi Anda</p>
                    </div>
                </div>
                <div class="flex gap-4 items-start">
            ...
            <div class="grid sm:grid-cols-2 gap-6">
                ...
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
                    ...
                    <div>
                        ...
                        <p class="font-sans text-sm text-slate-700" data-i18n="step3_desc">Tim kami menyusun website Anda dengan rapi.</p>
                    </div>
                </div>
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
        ...
        <div class="flex items-center justify-between gap-3">
            ...
            <div class="flex items-center gap-4">
                <div class="hidden sm:block text-right">
                    <p class="font-extrabold text-slate-900 text-sm leading-tight" data-i18n="svc_web_statis_name">{{ $service->name }}</p>
