...
<section class="py-10 md:py-14 bg-[#faf8ef] text-slate-900">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 text-center">
        <div class="inline-flex items-center gap-2 px-3.5 py-1.5 bg-[#8be4d6] text-slate-900 border-2 border-slate-900 rounded-lg text-xs font-black mb-5 shadow-[3px_3px_0px_0px_#1a1a1a]">
            <i class="fa-solid fa-file-excel text-slate-900"></i>
        ...
        <p class="font-sans text-sm sm:text-base text-slate-700 max-w-xl mx-auto mb-6">
            Pembuatan spreadsheet, formula/rumus otomatis, pivot table, dashboard grafik, dan otomasi Excel.
        </p>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 space-y-12">
        <div class="bg-white border-[2.5px] border-slate-900 p-6 sm:p-8 rounded-[24px] shadow-[6px_6px_0px_0px_#1a1a1a]">
            ...
            <div class="font-sans text-sm sm:text-base text-slate-700 space-y-4 leading-relaxed">
                <p>
                    Kami membantu Anda membuat file Excel atau Google Sheets yang kompleks dengan rumus otomatis, pivot table, grafik visualisasi, conditional formatting, hingga macro/VBA.
                </p>
                <p>
                    Sangat berguna untuk laporan keuangan bulanan, manajemen inventaris stok barang, analisis data penjualan, template gaji/payroll, dan kebutuhan pengolahan angka bisnis lainnya.
                </p>
            </div>
        </div>
        ...
        <div class="bg-white border-[2.5px] border-slate-900 p-6 sm:p-8 rounded-[24px] shadow-[6px_6px_0px_0px_#1a1a1a]">
            ...
            <div class="grid sm:grid-cols-2 gap-6">
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-base mb-1">Rumus & Formula Kompleks</h3>
                        <p class="font-sans text-xs text-slate-600">VLOOKUP, XLOOKUP, INDEX-MATCH, IF bercabang, SUMIFS, dll</p>
                    </div>
                </div>
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-base mb-1">Pivot Table & Dashboard Grafik</h3>
                        <p class="font-sans text-xs text-slate-600">Visualisasi data bisnis interaktif yang siap dipresentasikan</p>
                    </div>
                </div>
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-base mb-1">Template Dinamis & Reusable</h3>
                        <p class="font-sans text-xs text-slate-600">File dapat dipakai berulang kali untuk periode data baru</p>
                    </div>
                </div>
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-base mb-1">Panduan Penggunaan</h3>
                        <p class="font-sans text-xs text-slate-600">Petunjuk teknis sederhana cara menginput dan membaca rumus</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-[#ffdd44] border-[2.5px] border-slate-900 p-6 sm:p-8 rounded-[24px] shadow-[6px_6px_0px_0px_#1a1a1a]">
            ...
            <div class="grid sm:grid-cols-2 gap-6">
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-sm mb-1">Konsultasi Kebutuhan</h3>
                        <p class="font-sans text-xs text-slate-700">Jelaskan alur kalkulasi data, rumus yang diinginkan, atau contoh laporan.</p>
                    </div>
                </div>
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-sm mb-1">Desain & Pembuatan Rumus</h3>
                        <p class="font-sans text-xs text-slate-700">Perancangan struktur sheet, susunan tabel, dan penulisan formula.</p>
                    </div>
                </div>
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-sm mb-1">Uji Coba Data Sample</h3>
                        <p class="font-sans text-xs text-slate-700">Pengetesan akurasi rumus menggunakan sampel data sebelum final.</p>
                    </div>
                </div>
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-sm mb-1">Penyerahan File & Panduan</h3>
                        <p class="font-sans text-xs text-slate-700">Pengiriman file Excel (.xlsx) beserta penjelasan singkat penggunaannya.</p>
                    </div>
                </div>
            </div>
        </div>
