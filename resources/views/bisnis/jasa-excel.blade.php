        ...
        <div class="bg-white border-[2.5px] border-slate-900 p-6 sm:p-8 rounded-[24px] shadow-[6px_6px_0px_0px_#1a1a1a]">
            ...
            <div class="grid sm:grid-cols-2 gap-6">
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-lg mb-1">Rumus & Formula Kompleks</h3>
                        <p class="font-sans text-sm text-slate-600">VLOOKUP, XLOOKUP, INDEX-MATCH, IF bercabang, SUMIFS, dll</p>
                    </div>
                </div>
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-lg mb-1">Pivot Table & Dashboard Grafik</h3>
                        <p class="font-sans text-sm text-slate-600">Visualisasi data bisnis interaktif yang siap dipresentasikan</p>
                    </div>
                </div>
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-lg mb-1">Template Dinamis & Reusable</h3>
                        <p class="font-sans text-sm text-slate-600">File dapat dipakai berulang kali untuk periode data baru</p>
                    </div>
                </div>
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-lg mb-1">Panduan Penggunaan</h3>
                        <p class="font-sans text-sm text-slate-600">Petunjuk teknis sederhana cara menginput dan membaca rumus</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-[#ffdd44] border-[2.5px] border-slate-900 p-6 sm:p-8 rounded-[24px] shadow-[6px_6px_0px_0px_#1a1a1a]">
            ...
            <div class="grid sm:grid-cols-2 gap-6">
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-lg mb-1">Konsultasi Kebutuhan</h3>
                        <p class="font-sans text-sm text-slate-700">Jelaskan alur kalkulasi data, rumus yang diinginkan, atau contoh laporan.</p>
                    </div>
                </div>
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-lg mb-1">Desain & Pembuatan Rumus</h3>
                        <p class="font-sans text-sm text-slate-700">Perancangan struktur sheet, susunan tabel, dan penulisan formula.</p>
                    </div>
                </div>
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-lg mb-1">Uji Coba Data Sample</h3>
                        <p class="font-sans text-sm text-slate-700">Pengetesan akurasi rumus menggunakan sampel data sebelum final.</p>
                    </div>
                </div>
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-lg mb-1">Penyerahan File & Panduan</h3>
                        <p class="font-sans text-sm text-slate-700">Pengiriman file Excel (.xlsx) beserta penjelasan singkat penggunaannya.</p>
                    </div>
                </div>
            </div>
        </div>
