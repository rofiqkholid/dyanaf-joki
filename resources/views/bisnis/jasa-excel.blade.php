...
<section class="py-10 md:py-14 bg-[#faf8ef] text-slate-900">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 text-center">
        ...
        <h1 class="text-3xl sm:text-5xl font-extrabold text-slate-900 tracking-tight mb-4 leading-tight" data-i18n="svc_jasa_excel_name">
            {{ $service->name }}
        </h1>
        
        <p class="font-sans text-sm sm:text-base text-slate-700 max-w-xl mx-auto mb-6" data-i18n="svc_jasa_excel_desc">
            Pengerjaan formula, fungsi rumus kompleks, pivot table, dan analisis data Excel.
        </p>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 space-y-12">
        <div class="bg-white border-[2.5px] border-slate-900 p-6 sm:p-8 rounded-[24px] shadow-[6px_6px_0px_0px_#1a1a1a]">
            ...
            <div class="font-sans text-sm sm:text-base text-slate-700 space-y-4 leading-relaxed">
                <p data-i18n="jasa_excel_p1">
                    Jasa Olah Data & Rumus Excel membantu Anda memecahkan rumus kompleks (VLOOKUP, INDEX MATCH, IF bertingkat), pembuatan Pivot Table, pembuatan grafik dashboard interaktif, serta otomasi pekerjaan spreadsheet.
                </p>
            </div>
        </div>
        ...
        <div class="bg-white border-[2.5px] border-slate-900 p-6 sm:p-8 rounded-[24px] shadow-[6px_6px_0px_0px_#1a1a1a]">
            ...
            <div class="grid sm:grid-cols-2 gap-6">
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-lg mb-1" data-i18n="jasa_ex_feat1_title">Formula & Rumus Kompleks</h3>
                        <p class="font-sans text-sm text-slate-600" data-i18n="jasa_ex_feat1_desc">Pengerjaan VLOOKUP, INDEX MATCH, XLOOKUP, Nested IF, & logika bisnis</p>
                    </div>
                </div>
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-lg mb-1" data-i18n="jasa_ex_feat2_title">Pivot Table & Dashboard</h3>
                        <p class="font-sans text-sm text-slate-600" data-i18n="jasa_ex_feat2_desc">Visualisasi data interaktif & pembuatan laporan ringkas</p>
                    </div>
                </div>
                <div class="flex gap-4 items-start">
            ...
            <div class="grid sm:grid-cols-2 gap-6">
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
                    ...
                    <div>
                        ...
                        <p class="font-sans text-sm text-slate-700" data-i18n="step1_desc">Kirimkan file Excel mentah & instruksi pengolahan Anda.</p>
                    </div>
                </div>
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
                ...
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
                    ...
                    <div>
                        ...
                        <p class="font-sans text-sm text-slate-700" data-i18n="step3_desc">Tim kami mengolah formula Excel Anda dengan teliti.</p>
                    </div>
                </div>
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
        ...
        <div class="flex items-center justify-between gap-3">
            ...
            <div class="flex items-center gap-4">
                <div class="hidden sm:block text-right">
                    <p class="font-extrabold text-slate-900 text-sm leading-tight" data-i18n="svc_jasa_excel_name">{{ $service->name }}</p>
