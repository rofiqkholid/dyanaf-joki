        ...
        <div class="bg-white border-[2.5px] border-slate-900 p-6 sm:p-8 rounded-[24px] shadow-[6px_6px_0px_0px_#1a1a1a]">
            ...
            <div class="grid sm:grid-cols-2 gap-6">
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-base mb-1">Akurat & Terverifikasi</h3>
                        <p class="font-sans text-xs text-slate-600">Data diinput teliti dengan double-checking untuk meminimalisir typo</p>
                    </div>
                </div>
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-base mb-1">Struktur Format Rapi</h3>
                        <p class="font-sans text-xs text-slate-600">Hasil input tertata rapi sesuai kolom dan siap dianalisis</p>
                    </div>
                </div>
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-base mb-1">Pengerjaan Cepat</h3>
                        <p class="font-sans text-xs text-slate-600">Selesai tepat waktu sesuai kesepakatan deadline</p>
                    </div>
                </div>
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-base mb-1">Format Fleksibel</h3>
                        <p class="font-sans text-xs text-slate-600">Bisa dalam bentuk Excel (.xlsx), Google Sheets, CSV, atau DB</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-[#ffdd44] border-[2.5px] border-slate-900 p-6 sm:p-8 rounded-[24px] shadow-[6px_6px_0px_0px_#1a1a1a]">
            ...
            <div class="grid sm:grid-cols-2 gap-6">
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-sm mb-1">Pengiriman Sumber Data</h3>
                        <p class="font-sans text-xs text-slate-700">Kirimkan file mentah (scan, foto, PDF) beserta format yang diinginkan.</p>
                    </div>
                </div>
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-sm mb-1">Estimasi Volume & Waktu</h3>
                        <p class="font-sans text-xs text-slate-700">Pemeriksaan jumlah baris/halaman dan penentuan estimasi waktu pengetikan.</p>
                    </div>
                </div>
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-sm mb-1">Proses Input Data</h3>
                        <p class="font-sans text-xs text-slate-700">Penginputan data secara intensif dan sistematis oleh tim khusus.</p>
                    </div>
                </div>
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-sm mb-1">Check & Penyerahan</h3>
                        <p class="font-sans text-xs text-slate-700">Verifikasi kelengkapan data dan pengiriman file spreadsheet final.</p>
                    </div>
                </div>
            </div>
        </div>
