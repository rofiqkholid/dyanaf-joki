        ...
        <div class="bg-white border-[2.5px] border-slate-900 p-6 sm:p-8 rounded-[24px] shadow-[6px_6px_0px_0px_#1a1a1a]">
            ...
            <div class="grid sm:grid-cols-2 gap-6">
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-base mb-1">Logo & Branding</h3>
                        <p class="font-sans text-xs text-slate-600">Logo perusahaan, brand identity, dan style guide visual</p>
                    </div>
                </div>
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-base mb-1">Konten Media Sosial</h3>
                        <p class="font-sans text-xs text-slate-600">Desain post Instagram, Facebook, microblog, feed template</p>
                    </div>
                </div>
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-base mb-1">Materi Promosi & Cetak</h3>
                        <p class="font-sans text-xs text-slate-600">Banner, poster, flyer, brosur, kartu nama, & spanduk</p>
                    </div>
                </div>
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-base mb-1">Source File & Master File</h3>
                        <p class="font-sans text-xs text-slate-600">Mendapatkan file PNG, JPG, PDF, serta mentahan master</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-[#ffdd44] border-[2.5px] border-slate-900 p-6 sm:p-8 rounded-[24px] shadow-[6px_6px_0px_0px_#1a1a1a]">
            ...
            <div class="grid sm:grid-cols-2 gap-6">
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-sm mb-1">Brief & Konsep</h3>
                        <p class="font-sans text-xs text-slate-700">Sampaikan jenis desain, ukuran, warna yang diinginkan, dan contoh/referensi.</p>
                    </div>
                </div>
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-sm mb-1">Design Process</h3>
                        <p class="font-sans text-xs text-slate-700">Tim desainer merancang alternatif desain awal sesuai brief Anda.</p>
                    </div>
                </div>
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-sm mb-1">Preview & Revisi</h3>
                        <p class="font-sans text-xs text-slate-700">Pemeriksaan hasil preview dan proses penyesuaian/revisi hingga cocok.</p>
                    </div>
                </div>
                <div class="bg-white border-2 border-slate-900 p-4 rounded-xl shadow-[3px_3px_0px_0px_#1a1a1a] flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-extrabold text-slate-900 text-sm mb-1">Penyerahan File Final</h3>
                        <p class="font-sans text-xs text-slate-700">Pengiriman file final kualitas tinggi beserta berkas mentahan.</p>
                    </div>
                </div>
            </div>
        </div>
